 ...
 * Generated at: 2022-04-14 01:58:27 UTC
...
public final class content_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("		");
      out.write("\r\n");
      out.write("		<div class=\"replyPaging\">\r\n");
      out.write("		\r\n");
      out.write("		</div>\r\n");
      out.write("		\r\n");
      out.write("	</div>\r\n");
      ...
      out.write("			// #6. callback 함수 매개변수 수정, 안쪽 코드 수정/추가 \r\n");
      out.write("			replyService.getList({bno:bnoVal, page:page||1}, function(replyCount, data){ // replyCount, data 매개변수 2개로 수정  \r\n");
      out.write("				// #6. 추가 \r\n");
      ...
      out.write("				// #9. 댓글 페이징번호 띄우기 함수 호출 \r\n");
      out.write("				showReplyPaging(replyCount);\r\n");
      out.write("				\r\n");
      out.write("			});// replyService.getList\r\n");
      out.write("		}// showList\r\n");
      out.write("		\r\n");
      out.write("		// #8. 댓글 페이지 번호 출력 로직 추가 \r\n");
      out.write("		let pageNum = 1;  // 댓글 페이지 번호를 들고 있을 변수 \r\n");
      out.write("		let replyPaging = $(\".replyPaging\");  // 댓글 페이지번호 띄울 div 태그 가져오기 \r\n");
      out.write("		function showReplyPaging(replyCount) {\r\n");
      out.write("			let endNum = Math.ceil(pageNum / 10.0) * 10;  // 마지막 페이지 번호 (일단 10개로 보이게) \r\n");
      out.write("			let startNum = endNum - 9; 	// 시작 페이지 번호 \r\n");
      out.write("			let prev = startNum != 1;  	// 이전버튼  보일지 여부 \r\n");
      out.write("			let next = false; 			// 다음버튼 일단 false\r\n");
      out.write("			if(endNum * 10 >= replyCount) { // 페이지 번호 10개에 보여줘야되는 댓글수보다 전체 댓글 수가 적거나 같으면 \r\n");
      out.write("				endNum = Math.ceil(replyCount / 10.0); // 마지막 페이지 번호를 전체 나오는 페이지 수로 변경 \r\n");
      out.write("			}\r\n");
      out.write("			if(endNum * 10 < replyCount) { // 지금 보는 마지막 페이지번호에 보여줄 댓글수 보다 전체 댓글 수가많으면  \r\n");
      out.write("				next = true; //next 보여주기 값을 변경 \r\n");
      out.write("			}\r\n");
      out.write("			// 페이지 번호 띄워줄 html 구성 \r\n");
      out.write("			let str = \"<div class='replyPaing_content'>\";\r\n");
      out.write("			if(prev) {\r\n");
      out.write("				str += \"<a class='paging_link' href='\"+(startNum-1)+\"'> prev </a> \";\r\n");
      out.write("			}\r\n");
      out.write("			for(let i = startNum; i <= endNum; i++){\r\n");
      out.write("				str += \"<a class='paging_link' href='\"+i+\"'>&nbsp; \"+i+\" &nbsp;</a>\";\r\n");
      out.write("			}\r\n");
      out.write("			if(next){\r\n");
      out.write("				str += \" <a class='paging_link' href='\"+(endNum+1)+\"'> next </a></div>\";\r\n");
      out.write("			}\r\n");
      out.write("			\r\n");
      out.write("			replyPaging.html(str);\r\n");
      out.write("			// => showList에 showReplyPaging() 호출 추가 \r\n");
      out.write("		} \r\n");
      out.write("		\r\n");
      out.write("		// #10. 댓글 페이지 번호 이벤트 등록 \r\n");
      out.write("		replyPaging.on(\"click\", \"a.paging_link\", function(e){\r\n");
      out.write("			e.preventDefault();  // a 태그의 default기능(이동) 무시해라~	\r\n");
      out.write("			let pageLink = $(this).attr(\"href\"); // 클릭한 a태그의 href 값 가져오기 (이동할 댓글페이지번호)\r\n");
      out.write("			console.log(pageLink); \r\n");
      out.write("			pageNum = pageLink; // 밖에 만들어놓은 현재 페이지 변수에 덮어쓰기 \r\n");
  ...
  private boolean _jspx_meth_c_005fout_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/board/content.jsp(149,16) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
